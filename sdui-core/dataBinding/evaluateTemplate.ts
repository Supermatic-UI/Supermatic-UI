...
export function evaluateTemplate(
  ...
  console.log(
    '[dataBinding-evaluateTemplate] evaluateTemplate: ',
    template,
    dataContext
  );
  ...
  while (true) {
    ...
    console.log(
      '[dataBinding-evaluateTemplate] expressionStartIndex: ',
    ...
    console.log(
      '[dataBinding-evaluateTemplate] expressionEndIndex: ',
      expressionEndIndex
    );
    ...
    const expression = template
      .slice(expressionStartIndex + 2, expressionEndIndex)
      .trim();
